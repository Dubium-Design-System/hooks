...
/**
 * Время автоматического закрытия safe-zone по умолчанию (мс).
 */
export const HOVER_SAFE_ZONE_DEFAULT_TIMEOUT = 1500

/**
 * Отступ вокруг элементов safe-zone по умолчанию (px).
 */
export const HOVER_SAFE_ZONE_DEFAULT_PADDING = 16
